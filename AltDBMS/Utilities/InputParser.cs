    ...
    internal class InputParser
    {
        public void RUN()
        {
            ...
            while (true)
            {
                ...
                // CreateTable Sample2(Id:int, Name:string, BirthDate:date default “01.01.2022”)
                // Insert INTO Sample2 (Id,Name) VALUES (1,“Ivan”)
                // Insert INTO Sample2 (Id,Name) VALUES (2,“Petar”)
                // Insert INTO Sample2 (Id,Name,BirthDate) VALUES (3,“Georgi”,"02.02.2022")
                // Insert INTO Sample2 (BirthDate,Id,Name) VALUES ("03.03.2022",4,"Meesho")
                // Insert INTO Sample2 (BirthDate,Id,Name) VALUES ("04.04.2022",5,"Spas")
                // Insert INTO Sample2 (BirthDate,Id,Name) VALUES ("06.09.1999",69,"Evala")
                ...
                //DELETE FROM SampleCopy WHERE Name = "Petar" OR Id > 8

                //CREATEINDEX bd_index ON Sample2 (BirthDate)
